package com.github.lkapitman.rcon;

import com.github.lkapitman.rcon.ex.MalformedPacketException;
...
/**
 * The type Rcon packet.
 */
public record RconPacket(int requestId, int type, byte[] payload) {

	/**
	 * The constant SERVERDATA_EXECCOMMAND.
	 */
	public static final int SERVERDATA_EXECCOMMAND = 2;
	/**
	 * The constant SERVERDATA_AUTH.
	 */
